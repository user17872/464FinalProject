...
<a class="navbar-brand"> <h4> Welcome, 
    <?php
    ...
    <center> <form name="form1" action="" method="post">
        <!-- Form inputs here -->
        <input type="text" name="nameSearch" class="form-control" required placeholder=" Search for jobs here. Ex: Software Engineer"> 
        <br>
                    ...
                    if(isset($_POST['submit_form1'])) {
                        ...
                        if ($resultFound->num_rows > 0) {
                            ...
                            while($row = $resultFound->fetch_assoc()) {
                                ...
                                if (in_array($searchID , $beforeStack)) {
                                    ...
                                    echo "<div class='card' >";
                                        echo "<h5 class='card-header'>". $row["position"] ."</h5>";
                                            ...
                                            echo "<hr>";
                                                echo "<br><form method='post' action = 'addjobdb.php'id='form-$searchID'>" .
                                    ...
                                    echo "<div class='card'>";
                                        echo "<h5 class='card-header'>". $row["position"] ."</h5>";
                                            ...
                                            echo "<br><form method='post' action = 'addjobdb.php'id='form-$searchID'>" .
                                                ...
                                                "<br><br><input type='submit' class='btn btn-primary' value='$searchID' onclick='submitForm($searchID)'><br>" .
                                                "<input type='hidden' name='jobID' value='$searchID'>" .
                                                "</form>";
                                            echo "</div>";
                                        echo "</div>";
                                        ...
                                        echo "<h5 class='card-header'>". $row["position"] ."</h5>";
                                            ...
                                            echo "<hr>";
                                                echo "<br><form method='post' action = 'addjobdb.php'id='form-$jobID'>" .
                                                    ...
                                                    "<b>Job Type</b>: " . $row["jobType"] . "<br><br>" .
                                                    "<b>Compensation</b>: " . "$".$row["compensation"] .
                                                    "<br><br><input type='submit' value='Applied' class='btn btn-primary' onclick='submitForm($jobID)' disabled><br>" .
                                    ...
                                    echo "<div class='card'>";
                                        echo "<h5 class='card-header'>". $row["position"] ."</h5>";
                                            ...
                                            echo "<br><form method='post' action = 'addjobdb.php'id='form-$jobID'>" .
                                                ...
                                                "Job Type: " . $row["jobType"] . "<br><br>" .
                                                "Compensation: " . $row["compensation"] .
                                                "<br><br><input type='submit' class='btn btn-primary' value='$strjobID' onclick='submitForm($jobID)'><br>" .
                                                "<input type='hidden' name='jobID' value='$jobID'>" .
                                                "</form>";
                                            echo "</div>";
                                        echo "</div>";
